...
def main():
    ...
    A("```\n")
    A("The dataset and checkpoints are excluded from the repository by size, but the dataset")
    A("regenerates in about 30 seconds from `generate_dataset.py` at the recorded seed, and was")
    A("verified bit-for-bit reproducible.")
